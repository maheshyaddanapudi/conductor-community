...
public class OpenSearchProperties {
    ...
    /**
     * Document types are deprecated in ES6 and removed from ES7 and OpenSearch. This property can
     * be used to disable the use of specific document types with an override.
     *
