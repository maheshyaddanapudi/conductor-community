...
import com.netflix.conductor.opensearch.dao.index.OpenSearchRestDAO;
...
public class OpenSearchConfiguration {
    ...
    @Bean
    public RestClientBuilder openSearchRestClientBuilder(OpenSearchProperties properties) {
    ...
    @Primary
    @Bean
    public IndexDAO openSearchIndexDAO(
            RestClientBuilder openSearchRestClientBuilder,
            @Qualifier("openSearchRetryTemplate") RetryTemplate retryTemplate,
            OpenSearchProperties properties,
            ObjectMapper objectMapper) {
        return new OpenSearchRestDAO(
                openSearchRestClientBuilder, retryTemplate, properties, objectMapper);
    }
